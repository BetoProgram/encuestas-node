...
router.put('/usuarios/:id', (0, express_validator_1.param)('id').isInt().withMessage('ID no válido'), (0, express_validator_1.body)('nombre').notEmpty().withMessage('El nombre es obligatorio'), (0, express_validator_1.body)('telefono').notEmpty().withMessage('El telefono es obligatorio'), (0, express_validator_1.body)('direccion').notEmpty().withMessage('El domicilio es obligatorio'), (0, express_validator_1.body)('password').notEmpty().withMessage('El password no puede ser vacio')
    .isStrongPassword({
    minLength: 8,
    minLowercase: 1,
    minUppercase: 1,
    ...
    minSymbols: 1,
    returnScore: false
}).withMessage('El password debe de ser minimo 8 caractares, almenos una Mayuscula y caracterer especial'), middlewares_1.handleInputErrors, middlewares_1.authenticate, (0, middlewares_1.authorize)(['ADMIN']), UsuariosController_1.actualizaUsuarios);
router.delete('/usuarios/:id', (0, express_validator_1.param)('id').isInt().withMessage('ID no válido'), middlewares_1.handleInputErrors, middlewares_1.authenticate, (0, middlewares_1.authorize)(['ADMIN']), UsuariosController_1.eliminarUsuario);
