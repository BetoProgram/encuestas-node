...
import { actualizaUsuarios, eliminarUsuario } from './controllers/UsuariosController';
...
router.put('/usuarios/:id',
    ...
    body('direccion').notEmpty().withMessage('El domicilio es obligatorio'),
    ...
    handleInputErrors,
    authenticate, authorize(['ADMIN']), actualizaUsuarios);

router.delete('/usuarios/:id',
    param('id').isInt().withMessage('ID no válido'),
    handleInputErrors,
    authenticate, authorize(['ADMIN']), eliminarUsuario);
